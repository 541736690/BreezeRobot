...
public abstract class GyroTurningCommand extends Command {
    ...
    protected void execute() {
    	...
    	double curveSpeed = direction * ((delta >= RobotMap.GyroDegreeReduce)
    		   ? RobotMap.GyroTurnSpeedMaximum
    		   : (RobotMap.GyroTurnSpeedMaximum - RobotMap.GyroTurnSpeedMinimum) / RobotMap.GyroDegreeReduce * delta + RobotMap.GyroTurnSpeedMinimum
    	);
